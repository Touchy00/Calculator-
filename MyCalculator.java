...
public class MyCalculator {
    public static void main(String[] args){
        ...
        String value1 = sc.next();   // получает значение которое ввожит пользователь
        ...
        if (num1 == 0 | num2 == 0) { //если value1 или value2 не римское число, то n1 или n2 равно 0
            try { //весь код, который может вызвать исключения,находится в блоке трай
            ...
            } catch (NumberFormatException e) { // елли value1 value2 не арабское число (напмире "Даша / Маша")
                System.out.println(value1 + " или " + value2 + " не является арабской цифрой !");
                return;
            }
        }
        if (num1 >=1 && num1 <=10 && num2 >=1 && num2 <=10) {//условия калькулятора(1-10)будут работать только, в рамках одновременного обязательства
            ...
            System.out.println("Так делать не нааадо. Можно от 1-10");
        ...
        if (isArab){//проверка на арабское число имеет значение что было
            ...
            try {
                ...
                System.out.println("Отрицательных римских значений не существует " + e);
            }
        }
